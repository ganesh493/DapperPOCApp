...
namespace DapperPOC.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(ICompanyRepository componyRepo)
        {
        ...
        {
            return View(_componyRepo.GetCompanies());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var company = _componyRepo.Find(id.GetValueOrDefault());
            if (company == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,Name,Address,City,State,PostalCode")] Company company)
        {
            ...
            {
                _componyRepo.AddCompany(company);
        ...
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,Name,Address,City,State,PostalCode")] Company company)
        {
            ...
            if (ModelState.IsValid)
            {
                _componyRepo.UpdateCompany(company);
                return RedirectToAction(nameof(Index));
            }
            return View(company);
        }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            _componyRepo.DeleteCompany(id.GetValueOrDefault());
            return RedirectToAction(nameof(Index));
